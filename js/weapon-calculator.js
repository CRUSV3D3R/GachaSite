...
app.require(['weapons', 'resources', 'weapon-ascension', 'weapon-level'],
    function (weapons, resources, weaponAscension, weaponLevel) {
        ...
        if (app.shown) {
         ...
         // Handle select all and unselect all buttons for weapon selection
         $('#select-all', $weaponSelectTable).on('click', () => {
            $('.card-container[data-resource-type="weapons"]:not(.selected)', $weaponSelectContainer).click();
        });
        $('#unselect-all', $weaponSelectTable).on('click', () => {
            $('.card-container.selected[data-resource-type="weapons"]', $weaponSelectContainer).click();
        });
